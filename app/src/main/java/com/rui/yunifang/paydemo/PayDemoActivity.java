package com.rui.yunifang.paydemo;
...
public class PayDemoActivity extends FragmentActivity {
                ...
                case SDK_PAY_FLAG: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        if (TextUtils.equals(resultStatus, "8000")) {
                            ...
                            pay_state = OrderDao.WAIT_PAY;
                        }

                    }
                    //修改订单状态
					orderDao.updateState(CommonUtils.getSp("user_name"),listOrder.get(0).getCreate_time(),pay_state);
                    break;
                }
                default:
                    break;
    ...
    private ArrayList<OrderInfo> listOrder;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //接收传递的集合
        listOrder = (ArrayList<OrderInfo>) getIntent().getSerializableExtra("listOrder");
        orderDao = new OrderDao(PayDemoActivity.this);
    }
